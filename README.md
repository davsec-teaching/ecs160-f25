...
All submitted work must maintain a professional tone in all code, documentation, naming choices, and examples. Submissions may not include references to inappropriate or disrespectful themes. Content that does not meet reasonable professional standards may receive point deductions.
