...
5. Download 10 sample PNG files from the internet. Fuzz the generated binary for 3 hours **with these files as seeds.**
   1) Report the number of crashes found, the coverage, and the execution throughput.
...
2. Fuzz the generated by for 3 hours with the 10 sample PNG files downloaded in Part B as seeds.
3. Report the number of crashes found, the coverage, and the execution throughput.

### Part D: Write a custom mutator for LibPNG
...
2. Fuzz the binary generated in Part C with the custom mutator.
3. Report the number of crashes found, the coverage, and the execution throughput.
